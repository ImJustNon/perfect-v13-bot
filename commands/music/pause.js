...
module.exports = new Command({
    name: "pause",
    description: `หยุดเเล่นเพลงชั่วคราว`,
    ...
    run: async ({ client, interaction, args, prefix }) =>{
        ...
        else if(player.paused) return interaction.followUp('⚠ | ตอนนี้กำลังหยุดชั่วคราวอยู่น่ะ');
        else{
            player.pause(true);
		    interaction.followUp(`:white_check_mark: ทำการหยุดชั่วคราวเรียบร้อยเเล้ว`);
        }
    },
});